Feature: Comprar productos
    ...
    @compra_exitosa
    Scenario: Compra de productos con éxito
    ...
    @excepcion
    Scenario: Intento de compra fallido por carrito de compras vacío
    ...
    @excepcion
    Scenario: Intento de compra fallido por saldo insuficiente en la tarjeta de crédito
        Given el carrito de compras tiene productos
